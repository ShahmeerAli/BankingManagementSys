...
public class Project {
    ...
    static String[] DoctorList = new String[8];
    ...
    public static void AdmitPatient() {
        ...
        switch (option1) {
            case 1:
                ...
                System.out.println("Press 5 to Enter Main Menu");
    ...
    protected static void DoctorReg() {
        ...
        if (answer == 1) {
            ...
            String docInfo = name + "  " + CnicNo + "  " + field;
            info += docInfo;
            DoctorList[DoctorCount] = docInfo;
            DoctorCount++;
            System.out.println();
        } else if (answer == 2) {
            System.out.println("Enter the CNIC NO:");
            String cnic = input.next();
            if (info.contains(cnic)) {
                ...
                if (ans == 1) {
                    ...
                    if (field == 1) {
                        System.out.println("------------------------------------------------------");
                        System.out.println("NAME      AGE        GENDER       DATE");
                        for (int i = 0; i < NeurologyCount; i++) {
                            System.out.println(NeurologyList[i]);
                        }
                    } else if (field == 2) {
                        System.out.println("------------------------------------------------------");
                        System.out.println("NAME      AGE        GENDER       DATE");
                        for (int i = 0; i < OrthoCount; i++) {
                            System.out.println(OrthopedicList[i]);
                        }
                    } else if (field == 3) {
                        System.out.println("------------------------------------------------------");
                        System.out.println("NAME      AGE        GENDER       DATE");
                        for (int i = 0; i < CardioCount; i++) {
                            System.out.println(CardiologyList[i]);
                        }

                    } else if (field == 4) {
                        System.out.println("------------------------------------------------------");
                        System.out.println("NAME      AGE        GENDER       Initial Diagnostics          Date");
                        for (int i = 0; i < EmergencyCount; i++) {
                            System.out.println(EmergencyBed[i]);
                        }
                    } else {
                        System.out.println("Wrong Input!");
                    }
    ...
    public static void DocDetails() {
        try {
            ...
            int option = input.nextInt();
            if (option == 1) {
                System.out.println("Name             CNIC             FIELD");
                for (int i = 0; i < DoctorCount; i++) {
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public static String randomdoctor() {
        ...
        int Doctor = random2.nextInt(DoctorCount);
    ...
    public static void Appointment() {
        ...
        try {
            ...
            writer.write(String.format("Patient Name: %s . Age : %d  Phone Number : %s  .  Doctor's Name : %s \n", name, age, number, RandomDoctor));
            writer.close();
        } catch (IOException io) {
            System.out.println("Some Error Has occurred while writing the file");
        }
